...
Strategic initiatives that span the broader Smithy family — agent runtime, model routing, Kubernetes operator, template registry — are tracked on the [Smithy roadmap](https://iorubs.github.io/smithy/roadmap). Agent execution has already moved out of mcpsmithy and into [agentsmithy](https://iorubs.github.io/agentsmithy/); the remaining initiatives live at the family level until they have repos of their own.
