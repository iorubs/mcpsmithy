...
type Config struct {
	// Config schema version. Must be "2alpha".
...
type Project struct {
	...
	// Provider plugins used to extend the default capabilities
	Providers *ProjectProviders `yaml:"providers,omitempty"`
}
